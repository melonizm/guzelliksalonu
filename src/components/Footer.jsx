      ...
      <div className="bg-black-900 py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            <div>
              <Link to={link("/iletisim")} className="inline-block bg-gold-500 text-black-900 px-6 py-3 rounded-full font-bold hover:bg-gold-400 transition">
                Randevu Al
              </Link>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to={link("/")} className="text-gray-400 hover:text-gold-400 transition">Ana Sayfa</Link></li>
              <li><Link to={link("/hakkimizda")} className="text-gray-400 hover:text-gold-400 transition">Hakkımızda</Link></li>
              <li><Link to={link("/#services")} className="text-gray-400 hover:text-gold-400 transition">Hizmetler</Link></li>
              <li><Link to={link("/iletisim")} className="text-gray-400 hover:text-gold-400 transition">İletişim</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to={link("/hizmet/lazer-epilasyon")} className="text-gray-400 hover:text-gold-400 transition">Lazer Epilasyon</Link></li>
              <li><Link to={link("/hizmet/cilt-bakimi")} className="text-gray-400 hover:text-gold-400 transition">Cilt Bakımı</Link></li>
              <li><Link to={link("/hizmet/kas-vitamini")} className="text-gray-400 hover:text-gold-400 transition">Kaş Vitamini</Link></li>
              <li><Link to={link("/hizmet/lifting")} className="text-gray-400 hover:text-gold-400 transition">Lifting</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">{dbImages?.telefon || "(0212) 123 45 67"}</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-gold-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">{dbImages?.eposta || "info@guzelliksalonu.com"}</span>
              </li>
            </ul>
          </div>
        </div>
