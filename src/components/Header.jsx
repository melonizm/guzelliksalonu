        ...
        <div className="container mx-auto px-4 flex justify-between items-center text-sm">
          <div className="flex items-center space-x-4">
            <span className="flex items-center">
              ...
              {dbImages?.telefon || "(0212) 123 45 67"}
            </span>
            <span className="flex items-center">
              <svg className="w-4 h-4 mr-2 text-gold-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              {dbImages?.eposta || "info@guzelliksalonu.com"}
            </span>
          </div>
      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <Link to={link("/")} className="text-black-800 hover:text-gold-600 font-medium transition">ANASAYFA</Link>
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-48 bg-white shadow-lg rounded-lg py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform group-hover:translate-y-0 translate-y-2">
                <Link to={link("/hakkimizda")} className="block px-4 py-2 text-black-700 hover:bg-gold-50 hover:text-gold-600 transition">Hakkımızda</Link>
                <Link to={link("/hakkimizda")} className="block px-4 py-2 text-black-700 hover:bg-gold-50 hover:text-gold-600 transition">Misyon & Vizyon</Link>
              </div>
            </div>
            ...
            <Link to={link("/iletisim")} className="text-black-800 hover:text-gold-600 font-medium transition">İLETİŞİM</Link>
            
            <Link to={link("/iletisim")} className="bg-gold-500 text-white px-6 py-2 rounded-full hover:bg-gold-400 transition font-medium">
              Randevu Al
            </Link>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 space-y-3 pb-4">
            ...
            <Link to={link("/iletisim")} className="block bg-gold-500 text-white px-6 py-2 rounded-full text-center font-medium" onClick={() => setIsMenuOpen(false)}>Randevu Al</Link>
          </div>
        )}
      </nav>
    </header>
