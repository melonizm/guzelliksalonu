  ...
  if (!service) {
    return (
      <div className="pt-32 pb-20 container mx-auto px-4 text-center">
        ...
        <Link to={link("/")} className="text-gold-600 hover:text-gold-700 font-medium">
          Ana Sayfaya Dön
        </Link>
      </div>
    );
    ...
    <div className="pt-32">
      <div className="bg-gradient-to-r from-black-900 via-black-800 to-gold-600 text-white py-16">
        <div className="container mx-auto px-4">
          <Link to={link("/#services")} className="text-gold-200 hover:text-gold-100 text-sm mb-4 inline-block">
            ← Hizmetlerimize Dön
          </Link>
